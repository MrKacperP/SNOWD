      ...
      <div className="flex bg-gray-100 rounded-xl p-1 gap-1">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition ${
            activeTab === "chats" ? "bg-white text-[#2F6FED] shadow-sm" : "text-gray-500 hover:text-gray-700"
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition ${
            activeTab === "support" ? "bg-white text-[#2F6FED] shadow-sm" : "text-gray-500 hover:text-gray-700"
          }`}
        >
                  ...
                  {Object.values(currentChat.users).map(u => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                        viewingAs === u.uid ? "bg-[#2F6FED] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                      }`}
                    >
                  ...
                  return (
                    <div key={msg.id} className={`flex ${isOwn ? "justify-end" : "justify-start"}`}>
                      <div className={`max-w-[70%] px-4 py-2.5 rounded-2xl ${
                        isOwn ? "bg-[#2F6FED] text-white rounded-br-md" : "bg-gray-100 text-gray-900 rounded-bl-md"
                      }`}>
                        <p className={`text-xs font-medium mb-0.5 ${isOwn ? "text-white/70" : "text-[#2F6FED]"}`}>{msg.senderName}</p>
                  ...
                  return (
                    <div key={msg.id} className={`flex ${isAdmin ? "justify-end" : "justify-start"}`}>
                      <div className={`max-w-[75%] px-4 py-2.5 rounded-2xl ${
                        isAdmin ? "bg-[#2F6FED] text-white rounded-br-md" : "bg-gray-100 text-gray-900 rounded-bl-md"
                      }`}>
                        <p className={`text-xs font-medium mb-0.5 ${isAdmin ? "text-white/70" : "text-[#2F6FED]"}`}>
                          {msg.senderName}
                        </p>
                        <p className="text-sm">{msg.content}</p>
