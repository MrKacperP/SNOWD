        ...
        {Object.entries(STATUS_CONFIG).map(([key, cfg]) => (
          <button
            ...
            className={`p-3 rounded-xl border transition text-center ${
              statusFilter === key ? "border-[#2F6FED] bg-[#2F6FED]/5" : "border-gray-100 bg-white hover:border-gray-200"
            }`}
          >
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <Link href={`/admin/users/${selectedJob.clientId}`} className="text-xs text-[#2F6FED] hover:underline">View profile →</Link>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <Link href={`/admin/users/${selectedJob.operatorId}`} className="text-xs text-[#2F6FED] hover:underline">View profile →</Link>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex flex-wrap gap-1 mt-1">
                {selectedJob.serviceTypes?.map(s => (
                  <span key={s} className="px-2 py-0.5 bg-[#2F6FED]/10 text-[#2F6FED] text-xs rounded-full capitalize">{s.replace("-", " ")}</span>
                ))}
              </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-[#2F6FED] text-white rounded-xl text-sm font-semibold hover:bg-[#2158C7] transition"
            >
          ...
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full space-y-4" onClick={e => e.stopPropagation()}>
              ...
              {Object.entries(STATUS_CONFIG).map(([key, cfg]) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-xl border transition text-left ${
                    newStatus === key ? "border-[#2F6FED] bg-[#2F6FED]/5" : "border-gray-100 hover:border-gray-200"
                  }`}
                >
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#2F6FED] text-white rounded-xl text-sm font-semibold hover:bg-[#2158C7] transition disabled:opacity-50"
              >
          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full space-y-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2F6FED]/20"
              />
            </div>
              ...
              {operators
                ...
                .map(op => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 p-3 rounded-xl border transition text-left ${
                      op.uid === selectedJob.operatorId ? "border-green-200 bg-green-50 opacity-50" : "border-gray-100 hover:border-[#2F6FED]/20 hover:shadow-sm"
                    }`}
                  >
