    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        <h2 className="font-bold text-gray-900 flex items-center gap-2 mb-5">
          <Globe className="w-4 h-4 text-[#2F6FED]" /> General
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2F6FED]/20"
            />
          </div>
          <div>
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition border ${
                  active
                    ? "bg-[#2F6FED]/10 text-[#2F6FED] border-[#2F6FED]/20"
