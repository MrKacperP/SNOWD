          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#2F6FED]/20 focus:outline-none"
              />
            </div>
            <button
              onClick={handleSearch}
              disabled={searching || !searchTerm.trim()}
              className="px-5 py-3 bg-[#2F6FED] text-white rounded-xl font-medium hover:bg-[#2158C7] transition disabled:opacity-50 text-sm"
            >
          ...
          {results.length > 0 && (
            <div className="border border-gray-100 rounded-xl overflow-hidden divide-y divide-gray-50">
              {results.map(u => (
                ...
                >
                  <div className="w-9 h-9 bg-[#2F6FED]/10 rounded-full flex items-center justify-center text-[#2F6FED] font-bold text-sm shrink-0">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-medium capitalize ${
                    u.role === "operator" ? "bg-purple-100 text-purple-600" : "bg-[#2F6FED]/10 text-[#2F6FED]"
                  }`}>{u.role}</span>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#2F6FED]/10 rounded-full flex items-center justify-center text-[#2F6FED] font-bold text-lg">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
                ...
                <div key={i} className={`p-4 rounded-xl border transition ${
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#2F6FED]/20 focus:outline-none bg-white"
                    />
            ...
            <button
              ...
              className="w-full py-3 bg-[#2F6FED] text-white rounded-xl font-semibold hover:bg-[#2158C7] transition"
            >
              Verify Identity
            </button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
            <h2 className="font-semibold text-gray-800 flex items-center gap-2">
              <User className="w-5 h-5 text-[#2F6FED]" /> Account Details
            </h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="flex items-center justify-center gap-2 p-4 bg-[#2F6FED] text-white rounded-2xl font-medium hover:bg-[#2158C7] transition"
            >
