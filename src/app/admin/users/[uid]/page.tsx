    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 flex-1">
          <div className="w-12 h-12 bg-[#2F6FED]/10 rounded-full flex items-center justify-center text-[#2F6FED] font-bold text-xl">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium transition ${
            saved
              ...
              : "bg-[#2F6FED] text-white hover:bg-[#2158C7]"
          }`}
        >
      ...
      <div className="flex gap-1 bg-gray-100 rounded-xl p-1">
        {(["profile", "jobs", "transactions", "documents"] as const).map(t => (
          <button
            key={t}
            onClick={() => setTab(t)}
            className={`flex-1 py-2 text-sm font-medium rounded-lg capitalize transition ${tab === t ? "bg-white text-[#2F6FED] shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
          >
            {t}
          </button>
        ))}
            ...
            <div className="border-t border-gray-100 pt-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#2F6FED]/20 focus:outline-none resize-none"
                />
              </div>
            </div>
          )}
            ...
            {[
              ...
              <label key={key} className="flex items-center gap-3 cursor-pointer">
                <div
                  ...
                  className={`w-10 h-6 rounded-full transition-colors flex items-center px-1 ${fields[key] ? "bg-[#2F6FED]" : "bg-gray-200"}`}
                >
              ...
              {jobs.map(job => (
                <div key={job.id} className="px-5 py-4">
                  ...
                  <div className="mt-1 flex gap-2">
                    <Link href={`/dashboard/messages/${job.chatId}`} className="text-xs text-[#2F6FED] hover:underline flex items-center gap-1">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-gray-900 flex items-center gap-2 text-lg">
                  <FileText className="w-5 h-5 text-[#2F6FED]" /> Government ID
                </h3>
                <div className="flex items-center gap-2">
                  {isVerified ? (
                ...
                <>
                  {idLoadError ? (
                    <div className="text-center py-12 bg-gray-50 rounded-xl border border-gray-200 mb-4">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#2F6FED] text-white rounded-xl text-sm font-medium hover:bg-[#2158C7] transition"
                      >
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 text-sm text-[#2F6FED] hover:underline font-medium"
                    >
