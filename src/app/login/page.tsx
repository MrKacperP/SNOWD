      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-5xl grid md:grid-cols-[1.1fr_1fr] gap-6">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold font-headline text-[var(--text-primary)] mb-3">Welcome back</h1>
          ...
          >
            <div className="text-left mb-5">
              <h2 className="text-xl font-bold text-[var(--text-primary)]">Sign in with Google</h2>
              <p className="text-[var(--text-muted)] text-sm mt-1">Google is the only supported sign-in method.</p>
            </div>
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-[var(--text-muted)] text-xs">Use your Google account</p>
              </div>
            ...
            >
              New to snowd?{" "}
              <Link href="/signup" className="text-[var(--accent)] font-semibold hover:text-[var(--accent-dark)] transition">
                Create an account
              </Link>
            </motion.p>
          </motion.div>
