...
export default function TransactionsPage() {
  ...
  return <div className="mx-auto max-w-[1040px] space-y-5">
    ...
    <section className="grid grid-cols-2 gap-3" aria-label="Payment summary">
      <div className="rounded-3xl bg-[#eaf1ee] p-5"><p className="text-base text-[#43574b]">{isOperator ? "Job payments" : "Paid"}</p><p className="mt-2 break-words text-2xl font-semibold sm:text-3xl">{loading || error ? "—" : money(paid)}</p><p className="mt-1 text-xs text-[var(--text-muted)]">CAD · cash and card</p></div>
