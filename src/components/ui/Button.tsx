...
export default function Button({
  ...
  const baseStyles = 'inline-flex items-center justify-center gap-2 border border-transparent font-semibold transition-colors duration-150 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed';
  
  const variants = {
    primary: 'bg-[var(--accent)] hover:bg-[var(--accent-dark)] text-white shadow-[var(--surface-shadow)]',
    secondary: 'border-[var(--border-color)] text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] bg-[var(--card)]',
